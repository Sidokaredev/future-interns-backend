...
type Pipeline struct {
	...
	CandidateId string         `gorm:"type:nvarchar(256);uniqueIndex:idx_vacancy_candidate;not null"`
	VacancyId   string         `gorm:"type:nvarchar(256);uniqueIndex:idx_vacancy_candidate;not null"`
